...
def run_single_backtest(data_cache, symbols, trading_days, stop_loss, take_profit, min_score, initial_capital=100000):
    ...
    for date in trading_days:
        ...
        portfolio.equity_curve.append({"date": date, "equity": portfolio.get_equity(current_prices)})
