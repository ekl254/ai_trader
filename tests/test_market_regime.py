...
def test_detect_strong_bull(sample_spy_data):
    ...
    with patch("src.data_provider.alpaca_provider") as mock_provider:
        ...
        assert regime in [MarketRegime.STRONG_BULL, MarketRegime.BULL, MarketRegime.NEUTRAL]
...
def test_detect_bear():
    ...
    with patch("src.data_provider.alpaca_provider") as mock_provider:
        ...
        assert regime in [MarketRegime.STRONG_BEAR, MarketRegime.BEAR, MarketRegime.NEUTRAL]
